...
export default function MSLReferenceList() {
    ...
    const rows = [
        {
            uiAccountNumber: "000009251",
            unit: "000",
            layoffDate: "02/10/2023",
            recallDate: "02/17/2023",
            claimantsCount: 24,
            status: "completed",
            di: "",
            msl: ""
                                ...
                                <FormControl error={error} variant="standard" fullWidth>
                                    ...
                                    >
                                        <Grid container alignItems="center" spacing={1}>
                                            ...
                                            <Grid item md={4}>
                                                <TextField size='small' fullWidth id="unit" label="Unit" variant="outlined" />
                                            </Grid>
                                        </Grid>
                                        <Grid container mt={2} alignItems="center">
                                            ...
                                            <Grid item md={8}>
                                                <TextField size='small' fullWidth id="claimant" label="Claimant" variant="outlined" />
                                            </Grid>
                                        </Grid>
                                        <Grid container mt={2} alignItems="center">
                                            <Grid item md={4}>
